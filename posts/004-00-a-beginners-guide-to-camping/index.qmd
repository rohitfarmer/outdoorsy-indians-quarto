...
![Photo by <a href="https://unsplash.com/@tlisbin?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Tommy Lisbin</a> on <a href="https://unsplash.com/photos/2DH-qMX6M4E?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>](https://images.unsplash.com/photo-1487730116645-74489c95b41b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80){fig-alt="A night time scene of a campsite with multiple tents." .preview-image}
...
::: {.callout-tip}
Check out my previous article on [Essentials for Outdoor Survival](https://outdoorsyindians.com/posts/001-00-essentials-for-outdoor-survival/), which lists the essential items you might need in an outdoor survival situation. And here is the [camping checklist](https://www.rei.com/learn/expert-advice/family-camping-checklist.html) by REI.
:::
